...
function discuzcode($message, $bbcodeoff=0, $htmlon = 0, $allowbbcode = 1, $allowimgcode = 1, $allowhtml = 0, $parsetype = '1', $authorid = '0', $allowmediacode = '0', $pid = 0, $lazyload = 0, $pdateline = 0, $first = 0) {
	global $_G;
