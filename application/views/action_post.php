  ...
  <div class="pubQA">    
	...
	?>
      ...
      <ul class="pubQAForm">
        <li>
          <select>
            <option value="0" selected>选择主体分类</option>
      ...
      <ul class="pubQAForm">
        ...
        <button type="button" class="mainCmtBtn btnGray" disabled="disabled">预览</button>
        <button type="button" class="mainCmtBtn btnGray" disabled="disabled">保存在草稿</button>
        </li>
      </ul>
  </div> 
  <?php echo form_close() ?>
