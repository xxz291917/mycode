...
<table width="100%" height="100%">
	<tr>
		<td colspan="2" height="56px">
			<div class="head">
				<p class="r a-r t-tips">
				<a href="index.php" target="_blank">前台首页</a>|<a href="index.php?admin_main-logout">退出管理中心</a>
				</p>
				<ul id="nav">
	...
	<tr>
		<td width="160" valign="top" bgcolor="#F2F9FD">
			<div class="left">
				...
				<div style="display:none" id='menulist'>
					...
					<div id='content'>
						<ul>
							<li><a href="index.php?admin_doc" target="main"  class="on">主题管理</a></li>
							...
							<li><a href="index.php?admin_recycle" target="main">回收站</a></li>
                                        ...
                                        <div id='forums'>
						<ul>
							<li><a href="<?=base_url()?>index.php/admin/forums" target="main"  class="on">版块管理</a></li>
		...
		<td width="90%" height="90%"  valign="top">
		  <iframe name="main" id="main" marginheight="0" marginwidth="0" frameborder="0" scrolling="yes"  style="width:100%; height:100%; overflow:visible;" src="index.php?{$admin_mainframe}"></iframe>
		</td>
	</tr>
</table>
</body>
